 ...
 */
class Deconfin_Cache_File extends Deconfin_Cache_Abstract
{
  ...
  /**
   * @var Deconfin_Client the current client
   */
  private $client;
  ...
  public function delete($key)
  {
    ...
    if (file_exists($file) && !unlink($file)) {
      ...
      throw new Deconfin_Cache_Exception("Cache file could not be deleted");
    }
  ...
  private function getCacheDir($file, $forWrite)
  {
    ...
    if ($forWrite && ! is_dir($storageDir)) {
      if (! mkdir($storageDir, 0700, true)) {
        ...
        throw new Deconfin_Cache_Exception("Could not create storage directory: $storageDir");
      }
    }
    return $storageDir;
  }
