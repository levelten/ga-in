 ...
 */
class Deconfin_Cache_Memcache extends Deconfin_Cache_Abstract
{
  ...
  public function __construct(Deconfin_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new Deconfin_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws Deconfin_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new Deconfin_Cache_Exception("Couldn't store data in cache");
    }
