...
class Deconfin_Config
{
  ...
  /**
   * Create a new Deconfin_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Deconfin_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Deconfin_Cache_File',
      'logger_class'  => 'Deconfin_Logger_Null',
      ...
      'classes' => array(
        'Deconfin_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'Deconfin_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'Deconfin_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'Deconfin_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'Deconfin_Http_Request' => array(
        ...
        'Deconfin_Service_Exception' => array(
          'retry_map' => array(
        ...
        'Deconfin_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Deconfin_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see Deconfin_Auth_LoginTicket) after sign
