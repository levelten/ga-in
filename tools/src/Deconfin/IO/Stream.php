...
/**
 * Http Streams based implementation of Deconfin_IO.
 *
...
class Deconfin_IO_Stream extends Deconfin_IO_Abstract
{
  ...
  public function executeRequest(Deconfin_Http_Request $request)
  {
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new Deconfin_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new Deconfin_IO_Exception($error, $respHttpCode);
    }
