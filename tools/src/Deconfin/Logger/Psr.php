 ...
 * with the `Deconfin_Logger_Psr::setLogger()` method.
 */
class Deconfin_Logger_Psr extends Deconfin_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(Deconfin_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
